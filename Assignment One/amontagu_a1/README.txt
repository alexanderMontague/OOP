...
- Menu input
	- try to enter an invalid menu option
...
- Add stock/mutual fund
	- try to enter something other than stock or mutual fund
	- try to add another stock or mutual fund with the same symbol
...
- Sell stock/mutual fund
	...
	- selling with a negative number works (Technically legal I guess?)
...
- Update stock/mutual fund
	...
	- Allowed to update to negative value (also valid, never specified)
...
- Search for stock/mutual fund
	...
	- search with invalid keyword Ex. ‘banking’ or ‘ban’ in “bank of T.O”
	- search with exact wording
	- search with exact price
